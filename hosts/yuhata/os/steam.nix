...
}:
{
    ...
    programs.steam = {
        extraEnv = {
            ...
            SCB_GAMESCOPE_ARGS = "-f -w 5120 -h 2160 -W 5120 -H 2160 -r 75 --force-grab-cursor --backend sdl"; # scopebuddy -w 3200 -h 1800 -W 5120 -H 2160 -F nis  -f -r 150 -e --sdr-gamut-wideness 1 -- env SteamDeck=1
        };
