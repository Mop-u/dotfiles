...
in {
    ...
    config = {
        ...
        nixpkgs.config.permittedInsecurePackages = lib.optional (cfg.programs.sublime-text.enable || cfg.programs.sublime-merge.enable) "openssl-1.1.1w";
                ...
                (lib.mkIf cfg.programs.sublime-text.enable {
                    ...
                    stextCfg = {
                        ...
                        text = builtins.toJSON {
                            ...
                            update_check = false;
                            sublime_merge_path = if cfg.programs.sublime-merge.enable then "${pkgs.sublime-merge}/bin/sublime_merge" else null;
                        };
                    };
